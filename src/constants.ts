...
export const FORMATIONS: Formation[] = ['3-5-2', '4-2-3-1', '4-1-2-3', '3-4-3', '3-4-2-1', '4-4-2'];
...
export const FORMATION_POSITIONS: Record<Formation, Position[]> = {
  ...
  '3-5-2': [
    ...
    pos('rcm', 'RCM', 0.658519, 0.4496296667),
    pos('cm', 'CM', 0.5, 0.5237037037),
    pos('lcm', 'LCM', 0.341481, 0.4496296667),
  ...
  '3-4-2-1': [
    ...
    pos('lcm', 'LCM', 0.4, 0.52),
    pos('lm', 'LM', 0.17, 0.52),
    pos('rw', 'RW', 0.7151851852, 0.342037037),
    pos('st', 'ST', 0.5, 0.275),
    pos('lw', 'LW', 0.2848148148, 0.342037037),
  ],
};
